...
const Section4 = async (props: Props) => {
  const { lng } = useParams();
  const { t } = await useTranslation(lng.toString(), "section4");
  return (
    <>
      <section id="portfolio2" className="relative w-full snap-start bg-yellow-400 duration-1000">
