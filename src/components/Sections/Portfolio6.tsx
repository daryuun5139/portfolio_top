...
const Portfolio6 = ({ lng }: Props) => {
  const sectionName = "portfolio6";

  return (
    <>
      <section id="portfolio6" className="relative w-full snap-start">
        ...
        <div className="absolute top-[50px] flex h-[calc(100%-50px)] w-full 2xs:top-[60px] 2xs:h-[calc(100%-60px)] xs:top-[65px] xs:h-[calc(100%-65px)] sm:top-[80px] sm:h-[calc(100%-80px)] md:hidden landscape:hidden">
          <div className="mx-auto flex h-[90%] flex-col justify-between">
            ...
            <h1 className="flex pb-2 text-3xl 2xs:text-5xl xs:text-6xl sm:text-7xl">
              <span className="mx-auto flex cursor-default font-bold ">portfolio6</span>
            </h1>
            {/* 概要&画像部分-------------------- */}
          ...
          <div className="mx-auto flex w-[85%] justify-between 2xl:w-[70%]">
            ...
            <div className="flex w-[60%] flex-col">
              <h1 className="flex lg:text-8xl xl:text-9xl">
                <span className="mx-auto flex cursor-default font-bold lg:m-0">portfolio6</span>
              </h1>
