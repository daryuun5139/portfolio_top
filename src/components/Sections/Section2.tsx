      ...
      <section id="about" className="flex w-full snap-start items-center justify-center">
        <Carousel className="h-full w-full">
          <CarouselContent className="h-full w-full">
            {/* id="about_inner" ======================================================================== */}
            <CarouselItem className="flex h-screen w-full justify-center p-0">
            ...
            <CarouselItem className="flex h-screen w-full bg-pink-400 p-0">
              ...
              >
                <h1 className="absolute top-[18%] flex w-full landscape:top-[5%]">
                  <span className="mx-auto flex cursor-default text-6xl font-bold">profile</span>
                </h1>
                <div className="absolute top-[38%] flex w-[90%]">
                  <p className="flex cursor-default text-center leading-6 tracking-[3px] text-[#003566]">
                ...
                <div className="absolute top-[80%] flex w-full justify-start">
                  ...
                  <label htmlFor="CarouselPrevious_about">
                    <span className="ml-3 flex text-4xl font-semibold text-[#003566] underline hover:cursor-pointer hover:opacity-75">
                      ⇐back
                    </span>
                  </label>
                </div>
              ...
              >
                <div className="absolute top-[18%] flex flex-col">
                  <h1 className="flex">
                    <span className="mx-auto flex cursor-default text-8xl font-bold">profile</span>
                  </h1>
                  <div className="mx-auto flex w-[75%] pt-10">
                    <p className="flex cursor-default text-center leading-7 tracking-[3px] text-[#003566]">
                      当ブログにご訪問いただきありがとうございます。このブログは私が学んだこと、まとめたいことを記事にしているブログです。
                    </p>
                  </div>
                </div>
                <div className="absolute top-[80%] flex w-full justify-start">
                  <CarouselPrevious id="CarouselPrevious_about" />
                  <label htmlFor="CarouselPrevious_about">
                    <span className="ml-20 flex text-7xl font-semibold text-[#003566] underline hover:cursor-pointer hover:opacity-75">
                      ⇐back
                    </span>
                  </label>
                </div>
