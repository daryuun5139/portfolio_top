...
const TartanCheckDesign02 = ({ id }: Props) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        // viewBox="0 0 1950 1050"
      ...
      >
        <defs>
          ...
          >
            <g>
              <rect width="500" height="500" fill="none" strokeWidth="0" />
              <g>
                <rect x="253.85" width="46.79" height="500" fill="#7f272d" strokeWidth="0" />
                <rect x="339.1" width="26.28" height="500" fill="#7f272d" strokeWidth="0" />
                <rect x="136.54" width="48.08" height="500" fill="#7f272d" strokeWidth="0" />
                <rect x="0" width="13.46" height="500" fill="#7f272d" strokeWidth="0" />
                <rect x="388.46" width="26.44" height="500" fill="#7f272d" strokeWidth="0" />
                <rect x="476.44" width="23.56" height="500" fill="#7f272d" strokeWidth="0" />
                <rect x="55.77" width="38.46" height="500" fill="#7f272d" strokeWidth="0" />
                <rect x="40.38" width="15.38" height="500" fill="#1a6282" strokeWidth="0" />
                <rect x="13.46" width="15.38" height="500" fill="#1a6282" strokeWidth="0" />
                <rect x="28.85" width="11.54" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="236.54" width="17.31" height="500" fill="#1a6282" strokeWidth="0" />
                <rect x="184.62" width="17.31" height="500" fill="#1a6282" strokeWidth="0" />
                <rect x="201.92" width="11.54" height="500" fill="#977a00" strokeWidth="0" />
                <rect x="225" width="11.54" height="500" fill="#977a00" strokeWidth="0" />
                <rect x="380.77" width="7.69" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="365.38" width="7.69" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="373.08" width="7.69" height="500" fill="#977a00" strokeWidth="0" />
                <rect x="300.64" width="5.77" height="500" fill="#977a00" strokeWidth="0" />
                <rect x="333.33" width="5.77" height="500" fill="#977a00" strokeWidth="0" />
                <rect x="323.72" width="9.62" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="306.41" width="9.62" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="414.9" width="7.69" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="468.75" width="7.69" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="459.13" width="9.62" height="500" fill="#977a00" strokeWidth="0" />
                <rect x="422.6" width="9.62" height="500" fill="#977a00" strokeWidth="0" />
                <rect x="449.52" width="9.62" height="500" fill="#1a6282" strokeWidth="0" />
                <rect x="432.21" width="9.62" height="500" fill="#1a6282" strokeWidth="0" />
                <rect x="213.46" width="11.54" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="121.15" width="15.38" height="500" fill="#003e5b" strokeWidth="0" />
                <rect x="94.23" width="15.38" height="500" fill="#003e5b" strokeWidth="0" />
                <rect x="316.03" width="7.69" height="500" fill="#1a6282" strokeWidth="0" />
                <rect x="441.83" width="7.69" height="500" fill="#c69c6d" strokeWidth="0" />
                <rect x="109.62" width="11.54" height="500" fill="#977a00" strokeWidth="0" />
              </g>
              <g>
                <polygon
                ...
                <polygon
                  ...
                  strokeWidth="0"
                />
                <polygon points="0 160.9 0 162.75 1 160.9 0 160.9" fill="#977a00" strokeWidth="0" />
                <polygon
                ...
                <polygon
                  ...
                  strokeWidth="0"
                />
                <polygon points="0 77.4 0 79.69 1.23 77.4 0 77.4" fill="#c69c6d" strokeWidth="0" />
                <polygon
                ...
                <polygon
                  ...
                  strokeWidth="0"
                />
                <polygon points="0 275 0 279.02 2.17 275 0 275" fill="#c69c6d" strokeWidth="0" />
                <polygon
        ...
        <rect className="h-full w-full" fill="url(#_新規パターンスウォッチ_2)" strokeWidth="0" />
      </svg>
    </>
  );
};

export default TartanCheckDesign02;
